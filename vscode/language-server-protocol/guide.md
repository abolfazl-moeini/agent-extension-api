# VS Code Language Server Extension Guide (LSP)
...
![LSP Languages and Editors](/assets/api/language-extensions/language-server-extension-guide/lsp-languages-editors.png)
...
![LSP Illustration](/assets/api/language-extensions/language-server-extension-guide/lsp-illustration.png)
...
*   If you want to underline with a squiggle until the end of the line, then set the character of the end position to Number.MAX\_VALUE.
...
![Validating a text file](/assets/api/language-extensions/language-server-extension-guide/validation.png)
...
![Debugging the client](/assets/api/language-extensions/language-server-extension-guide/debugging-client.png)
...
![Debugging the server](/assets/api/language-extensions/language-server-extension-guide/debugging-server.png)
...
![LSP Log](/assets/api/language-extensions/language-server-extension-guide/lsp-log.png)
...
![Maximum One Problem](/assets/api/language-extensions/language-server-extension-guide/validationOneProblem.png)
...
![Code Complete](/assets/api/language-extensions/language-server-extension-guide/codeComplete.png)
...
6/10/2026
 ...
 ![Search](/assets/icons/search-dark.svg) ![Search](/assets/icons/search.svg)